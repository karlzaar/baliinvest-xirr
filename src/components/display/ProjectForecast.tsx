...
export function ProjectForecast({ result, location, currency, formatAbbrev }: Props) {
    ...
    <div className="sticky top-28 flex flex-col gap-6">
      ...
      <div className="rounded-xl border border-border-dark bg-[#102216] p-6 shadow-xl">
        ...
        <div className="mt-6 space-y-3">
          <button className="w-full flex items-center justify-center gap-2 rounded-lg bg-primary py-3 text-[#112217] font-bold hover:bg-[#10d652] transition-colors">
            <span className="material-symbols-outlined">calculate</span>
            Calculate Final XIRR
          </button>
          <button className="w-full flex items-center justify-center gap-2 rounded-lg border border-border-dark py-3 text-text-secondary text-sm hover:text-white transition-colors">
