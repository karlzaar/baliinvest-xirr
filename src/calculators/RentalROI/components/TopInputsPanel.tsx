      ...
      {showOccupancyGrowth && (
        <div className="mt-8 pt-8 border-t border-slate-100 animate-in fade-in slide-in-from-top-2 duration-300">
          <div className="flex items-center gap-2 mb-6">
            <h4 className="text-[10px] font-black text-slate-600 uppercase tracking-widest">Yearly Occupancy Point Increase</h4>
...
const TopInputGroup: React.FC<{
  ...
  return (
    <div className="space-y-2">
      <label className="flex items-center gap-1 text-[10px] font-black uppercase tracking-widest text-slate-600">
        {label}
